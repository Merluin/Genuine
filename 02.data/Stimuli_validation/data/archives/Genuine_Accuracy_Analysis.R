...
plot(residuals(fit2))
# anova
AnovaFit1 <- car::Anova(fit1, type = 3) # no effect
...
# This will give you the EMMs for the interaction of emotion and elicitation
interaction_emmeans <- emmeans(fit2, ~ emotion | elicitation)

# To look at pairwise comparisons within each emotion for different elicitation levels
interaction_pairwise <- emmeans(fit2, pairwise ~ emotion | elicitation)
