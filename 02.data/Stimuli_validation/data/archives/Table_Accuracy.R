...
summary_emotion <- summary_participants %>%
  ...
  summarise(
    ...
    genuine.acc.sd = sd(genuine.acc.sd, na.rm = TRUE),
    genuine.rt.mean = mean(genuine.rt.mean, na.rm = TRUE),
    genuine.rt.sd = sd(genuine.rt.sd, na.rm = TRUE),
    genuine.slider1.mean = mean(genuine.slider1.mean, na.rm = TRUE),
    genuine.slider1.sd = sd(genuine.slider1.sd, na.rm = TRUE),
    genuine.slider0.mean = mean(genuine.slider0.mean, na.rm = TRUE),
    genuine.slider0.sd = sd(genuine.slider0.sd, na.rm = TRUE),
    emotion.acc.mean = mean(emotion.acc.mean, na.rm = TRUE),
    emotion.acc.sd = sd(emotion.acc.sd, na.rm = TRUE),
    emotion.slider1.mean = mean(emotion.slider1.mean, na.rm = TRUE),
    emotion.slider1.sd = sd(emotion.slider1.sd, na.rm = TRUE),
    emotion.slider0.mean = mean(emotion.slider0.mean, na.rm = TRUE),
    emotion.slider0.sd = sd(emotion.slider0.sd, na.rm = TRUE)
  ) %>%
  ungroup() %>%
...
n_clips = length(unique(dataset_pulito$file))
...
table <- final_dataset%>% 
  ...
  add_header_row(values = c(paste("Pts =",n_pts, "mp4 = ",n_clips ), "", 
  ...
  add_footer_lines(values = paste("eliminated clips = ",bad_clips," = ",acc_clips, "% accuracy"))
